...
// File @openzeppelin/contracts/math/SafeMath.sol@v3.2.0-solc-0.7
...
// File @openzeppelin/contracts/token/ERC20/IERC20.sol@v3.2.0-solc-0.7
...
// File @openzeppelin/contracts/utils/Address.sol@v3.2.0-solc-0.7
...
// File @openzeppelin/contracts/token/ERC20/ERC20.sol@v3.2.0-solc-0.7
...
// File @openzeppelin/contracts/token/ERC20/ERC20Burnable.sol@v3.2.0-solc-0.7
...
contract Goldtoken is ERC20Burnable, Ownable {
  ...
  constructor() ERC20("CGold", "CGLD") Ownable() {
    // _owner = _msgSender();
